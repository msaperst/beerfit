...
public class GoalsSeededAppiumTest extends AppiumTestBase {
    ...
    public void viewGoalAllData() {
        List<WebElement> tableRows = drivers.get().findElement(By.id("goalsTable")).findElements(By.className("android.widget.TableRow"));
        tableRows.get(0).click();
        assertElementTextEquals("Walk", drivers.get().findElement(By.id("goalExercise")).findElement(By.className("android.widget.TextView")));
        assertElementTextEquals("5.0", By.id("goalAmount"));
        assertElementTextEquals("kilometer", drivers.get().findElement(By.id("goalMeasurement")).findElement(By.className("android.widget.TextView")));
    }
    ...
    public void viewGoalUpdate() throws SQLException, IOException, ClassNotFoundException {
        ...
        drivers.get().findElement(By.id("goalAmount")).clear();
        drivers.get().findElement(By.id("goalAmount")).sendKeys("30");
