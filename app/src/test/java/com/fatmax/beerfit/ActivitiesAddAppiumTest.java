...
public class ActivitiesAddAppiumTest extends AppiumTestBase {
    ...
    public void addActivityViewContentExists() {
        ...
        assertElementTextEquals("", drivers.get().findElement(By.id("activityExercise")));
        assertElementTextEquals("for", drivers.get().findElement(By.id("_for_")));
        assertElementTextEquals("", By.id("activityAmount"));
        assertElementTextEquals("", drivers.get().findElement(By.id("activityMeasurement")));
    }
    ...
    public void addEmptyActivity() {
        ...
        assertElementTextEquals("You need to indicate some exercise", drivers.get().findElement(By.id("activityExercise")).findElement(By.className("android.widget.TextView")));
        assertElementTextEquals("", By.id("activityAmount"));
        assertElementTextEquals("", drivers.get().findElement(By.id("activityMeasurement")).findElement(By.className("android.widget.TextView")));
    }
    ...
    public void canChangeDate() {
        ...
        if (currentMonth != calendar.get(Calendar.MONTH) || currentYear != calendar.get(Calendar.YEAR)) {
            drivers.get().findElement(By.id("android:id/prev")).click();
        }
        drivers.get().findElement(By.AccessibilityId(new SimpleDateFormat("dd MMMM yyyy", Locale.US).format(calendar.getTime()))).click();
        drivers.get().findElement(By.id("android:id/button1")).click();
        assertElementTextEquals(DATE_FORMAT.format(calendar.getTime()), By.id("activityDate"));
    }
    ...
    public void canChangeTimeAM() {
        ...
        drivers.get().findElement(By.id("android:id/am_label")).click();
        drivers.get().findElement(By.id("android:id/button1")).click();
