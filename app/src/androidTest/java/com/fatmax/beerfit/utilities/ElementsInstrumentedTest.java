...
public class ElementsInstrumentedTest {
    ...
    public void getAllActivitiesInOrderTest() {
        ...
        database.setupDatabase();
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(1,'2020-10-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(2,'2020-10-10 10:26',2,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 11:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-10-10 09:23',1,2,5,0);");
    ...
    public void getAllActivityTimesByYearAscTest() {
        ...
        Database database = new Database(db);
        database.setupDatabase();
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(1,'2020-08-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(2,'2020-10-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-08-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(5,'2021-11-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(6,'2021-11-11 10:23',0,0,2,-2);");
    ...
    public void getAllActivityTimesByWeekAscTest() {
        ...
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-08-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(5,'2021-02-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(6,'2021-02-11 10:23',0,0,2,-2);");
    ...
    public void getActivitiesGroupedByExerciseAndTimeFrameByYearTest() {
        ...
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(2,'2020-10-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-08-09 10:23',2,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(5,'2021-11-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(6,'2021-11-11 10:23',0,0,2,-2);");
        Data data = new Data();
    ...
    public void getBeersDrankFullTable() {
        ...
        Database database = new Database(db);
        database.setupDatabase();
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(1,'2020-08-09 10:23',0,0,1,-1);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(2,'2020-10-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 10:23',0,0,1,-1);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-08-09 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(5,'2021-11-10 10:23',1,2,5,0);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(6,'2021-11-11 10:23',0,0,2,-2);");
    ...
    public void getActivitiesPerformedFullTable() {
        ...
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(1,'2020-08-09 10:23',1,2,5,5);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(2,'2020-10-09 10:23',1,2,5,5);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(3,'2020-10-10 10:23',0,0,1,-1);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(4,'2020-08-09 10:23',2,2,1,0.2);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(5,'2021-11-10 10:23',1,2,5,5);");
        db.execSQL("INSERT INTO " + ACTIVITIES_TABLE + " VALUES(6,'2021-11-11 10:23',0,0,2,-2);");
